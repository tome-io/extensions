...
- any reviewed host adapters it may invoke.
...
Reviewed host add-ons, such as Moon+ Reader, live in this repository because their
external artifact is a declarative manifest. The narrowly permissioned native adapter
remains in Tomeio core and is dormant until the user installs and configures the add-on.
...
Build hosted add-ons with [`@tomeio/addon-sdk`](https://github.com/tome-io/addon-sdk).
Executable JavaScript bundle transports are not accepted.
